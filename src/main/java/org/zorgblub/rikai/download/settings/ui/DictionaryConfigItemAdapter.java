...
public class DictionaryConfigItemAdapter extends DragItemAdapter<Pair<Integer, DictionarySettings>, DictionaryConfigItemAdapter.ViewHolder> {
    ...
    public DictionaryConfigItemAdapter(ArrayList<Pair<Integer, DictionarySettings>> list, int layoutId, int grabHandleId, boolean dragOnIntegerPress, FragmentActivity activity) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(v.getContext())
                    ...
                    .setPositiveButton(R.string.action_delete, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Toast toast = Toast.makeText(v.getContext(), R.string.dictionary_remove_success, Toast.LENGTH_SHORT);
                            toast.show();
                        }
