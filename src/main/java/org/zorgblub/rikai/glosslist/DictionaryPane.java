...
public class DictionaryPane extends DraggablePane implements DictionaryServiceImpl.DictionaryListener {
    ...
    private class ClickListener implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener{
        ...
        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            try {
                ...
                dictionaryService.saveInAnki(e, DictionaryPane.this.getContext(), selectedWord, bookReader.getBookTitle());
            }catch(IllegalAccessException e){
                bookReader.requestPermission();
        ...
        public boolean shouldRequestPermission() {
            ...
            return ContextCompat.checkSelfPermission(getContext(), READ_WRITE_PERMISSION) != PackageManager.PERMISSION_GRANTED;
        }
    ...
    public void onWordChanged(SelectedWord word){
        if(pagerAdapter == null) {
            Toast notReadyToast = Toast.makeText(this.getContext(), "Dictionary not ready yet", Toast.LENGTH_SHORT);
            notReadyToast.show();
            return;
        }
        pagerAdapter.setSelectedWord(word);
